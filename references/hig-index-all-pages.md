...
> 抓取时间: 2026-09-14。本 skill references 只收录核心子集，其余页面按 URL 查阅原文。

| 主题 | URL |
|---|---|
| **getting-started（分类页）** | https://developer.apple.com/design/human-interface-guidelines/getting-started |
...
| **foundations（分类页）** | https://developer.apple.com/design/human-interface-guidelines/foundations |
...
| **patterns（分类页）** | https://developer.apple.com/design/human-interface-guidelines/patterns |
...
| **components（分类页）** | https://developer.apple.com/design/human-interface-guidelines/components |
...
| **inputs（分类页）** | https://developer.apple.com/design/human-interface-guidelines/inputs |
...
| **technologies（分类页）** | https://developer.apple.com/design/human-interface-guidelines/technologies |
